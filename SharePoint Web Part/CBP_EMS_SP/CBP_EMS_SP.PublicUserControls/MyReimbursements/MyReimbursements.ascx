...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyReimbursements.ascx.cs" Inherits="CBP_EMS_SP.PublicUserControls.MyReimbursements.MyReimbursements" %>
...
<div class="card-theme page_main_block">
    ...
    <table class="custtable">
        ...
        <asp:Repeater ID="rptrReimbursementListCASP" OnItemDataBound="rptrReimbursementListCASP_ItemDataBound" runat="server">
            <HeaderTemplate>
                <tbody>
            </HeaderTemplate>
            <ItemTemplate>
