...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VMListWP.ascx.cs" Inherits="CBP_EMS_SP.VMListWP.VMListWP.VMListWP" %>
...
<div class="outsideboard  page_main_block" style="width: 100%">
    <asp:Panel ID="MainPanel" runat="server" CssClass="aspPanel" >
                <h1 class="titleFont">Vetting Meeting List</h1><br />
                     <asp:GridView ID="gvTable" CssClass="gvTable" runat="server" AutoGenerateColumns="false" GridLines="None" ShowHeaderWhenEmpty="true" 
                        ...
                        <Columns>                         
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID=btnview runat=server Text="Programme Name" CommandName="Programme Name" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>' CssClass="textGreenFont" ToolTip="View applications for programme intakes">
                            </asp:LinkButton>
                            </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="btnDeclaration" runat="server" Text="Declaration" CommandName="Declaration" CommandArgument='<%# ((GridViewRow) Container).RowIndex %>'></asp:LinkButton>
                            </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                              <ItemTemplate>                      
                                ...
                                <asp:HiddenField ID="HiddenProgramme_Name" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "Programme_Name") %>' />
                            ...
                            CommandArgument="<%# ((GridViewRow) Container).RowIndex %>"
                                  Text="Edit" ImageUrl="~/_layouts/15/Images/CBP_EMS_SP.VMArrangeWebPart/viewPresentation.png" Width="31px" ToolTip="View presentation list"/>
                              </ItemTemplate> 
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>             
