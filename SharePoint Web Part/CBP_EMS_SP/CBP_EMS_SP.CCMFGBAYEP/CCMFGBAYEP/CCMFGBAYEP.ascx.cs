...
namespace CBP_EMS_SP.CCMFGBAYEP.CCMFGBAYEP
{
    ...
    public partial class CCMFGBAYEP : WebPart
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rdo_HK.Text = SPFunctions.LocalizeUI("Hong_Kong_Programme", "CyberportEMS_CCMFGBAYEP");
            rdo_Crossborder.Text = SPFunctions.LocalizeUI("Cross_Border_Programme_Supported_by_CCMF", "CyberportEMS_CCMFGBAYEP");
            rdo_CUPP.Text = SPFunctions.LocalizeUI("Cyberport_University_Partnership_Programme", "CyberportEMS_CCMFGBAYEP");
            rdo_CCMFGBAYEP.Text = SPFunctions.LocalizeUI("Cyberport_Greater_Bay_Area_Young_Entrepreneurship_Programme_Supported_by_CCMF", "CyberportEMS_CCMFGBAYEP");
            ...
            if (!Page.IsPostBack && string.IsNullOrEmpty(ctrlname))
            {
                ...
                crossborderoptions.Add(new ListItem() { Value = "CrossBorder-Shenzhen", Text = SPFunctions.LocalizeUI("CyberportShenzhen_Hong_Kong_Young_Entrepreneur_Programme1", "CyberportEMS_CCMFGBAYEP") });
                crossborderoptions.Add(new ListItem() { Value = "CrossBorder-Guangdong", Text = SPFunctions.LocalizeUI("CyberportGuangdong__Hong_Kong_Young_Entrepreneur_Programme1", "CyberportEMS_CCMFGBAYEP") });
                ...
                Contactarea.Add(new ListItem() { Value = "HongKong", Text = SPFunctions.LocalizeUI("Contact_HongKong", "CyberportEMS_CCMFGBAYEP") });
                Contactarea.Add(new ListItem() { Value = "China", Text = SPFunctions.LocalizeUI("Contact_China", "CyberportEMS_CCMFGBAYEP") });
            ...
            HKOptions.Add(new ListItem() { Value = "Professional", Text = SPFunctions.LocalizeUI("Professional_Stream", "CyberportEMS_CCMFGBAYEP") });
            HKOptions.Add(new ListItem() { Value = "Young Entrepreneur", Text = SPFunctions.LocalizeUI("Hong_Kong_Young_Entrepreneur", "CyberportEMS_CCMFGBAYEP") });
            ...
            CCMFApplication.Add(new ListItem() { Value = "Individual", Text = SPFunctions.LocalizeUI("Individual_Application", "CyberportEMS_CCMFGBAYEP") });
            CCMFApplication.Add(new ListItem() { Value = "Company", Text = SPFunctions.LocalizeUI("Company_Application", "CyberportEMS_CCMFGBAYEP") });
            ...
            busniessareaoption.Add(new ListItem() { Value = "AI/Big data", Text = SPFunctions.LocalizeUI("Step3_OpenData", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Application Development", Text = SPFunctions.LocalizeUI("Step3_AppDesign", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Blockchain", Text = SPFunctions.LocalizeUI("Step3_Blockchain", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Cybersecurity", Text = SPFunctions.LocalizeUI("Step3_Cybersecurity", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Edtech", Text = SPFunctions.LocalizeUI("Step3_Edutech", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "EnvironmenTech", Text = SPFunctions.LocalizeUI("Step3_EnvironmenTech", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "E-sport/Digital Entertainment", Text = SPFunctions.LocalizeUI("Step3_Gaming", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "FinTech", Text = SPFunctions.LocalizeUI("Step3_Fintech", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "HealthTech", Text = SPFunctions.LocalizeUI("Step3_Healthcare", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "MarTech", Text = SPFunctions.LocalizeUI("Step3_MarTech", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "RetailTech / E-commerce", Text = SPFunctions.LocalizeUI("Step3_ECommerce", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Robotics / IoT", Text = SPFunctions.LocalizeUI("Step3_Wearable", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Smart Building", Text = SPFunctions.LocalizeUI("Step3_Smart_Building", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Smart Mobility", Text = SPFunctions.LocalizeUI("Step3_Smart_Mobility", "CyberportEMS_CCMFGBAYEP") });
            busniessareaoption.Add(new ListItem() { Value = "Others", Text = SPFunctions.LocalizeUI("Step3_Others", "CyberportEMS_CCMFGBAYEP") });
            ...
            smartspacelist.Add(new ListItem() { Value = "No", Text = SPFunctions.LocalizeUI("Step_3_Smart_Space_No", "CyberportEMS_CCMFGBAYEP") });
            smartspacelist.Add(new ListItem() { Value = "SS8", Text = SPFunctions.LocalizeUI("Step_3_Smart_Space_SS8", "CyberportEMS_CCMFGBAYEP") });
            smartspacelist.Add(new ListItem() { Value = "Others", Text = SPFunctions.LocalizeUI("Step_3_Smart_Space_Others", "CyberportEMS_CCMFGBAYEP") });
        ...
        protected void SetUpHeader()
        {
            ...
            using (var Intake = new CyberportEMS_EDM())
            {
                ...
                {
                    mainpageheading.Text = SPFunctions.LocalizeUI("CCMF_GBAYEP_Header", "CyberportEMS_CCMFGBAYEP");

                    //if (objProgram.Programme_Name.ToLower().Contains("cross border"))
                    //{
                    //    mainpageheading.Text = SPFunctions.LocalizeUI("CCMF_CrossBorder_Header", "CyberportEMS_CCMFGBAYEP");
                    //}
                    //else if (objProgram.Programme_Name.ToLower().Contains("hong kong"))
                    //{
                    //    mainpageheading.Text = SPFunctions.LocalizeUI("CCMF_HK_Header", "CyberportEMS_CCMFGBAYEP");
                    //}
                    //else
                    //{
                    //    mainpageheading.Text = SPFunctions.LocalizeUI("CUPP_Header", "CyberportEMS_CCMFGBAYEP");
                    //}
                }
            }
        }
        ...
        protected void FillIntakeDetails()
        {
            try
            {
                ...
                using (var Intake = new CyberportEMS_EDM())
                {
                    ...
                    {
                        rdo_CCMFGBAYEP.Enabled = true;
                        rdo_CCMFGBAYEP.Checked = true;
        ...
        {
            return SPFunctions.LocalizeUI(Key, "CyberportEMS_CCMFGBAYEP");
        }
                ...
                case "cbi":
                    {
                        ...
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("Cross_Border_Programme_Supported_by_CCMF", "CyberportEMS_CCMFGBAYEP");
                        Applicant.Text = SPFunctions.LocalizeUI("Individual_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        lbl211a.Text = SPFunctions.LocalizeUI("CCMF_Ind_1_A", "CyberportEMS_CCMFGBAYEP");
                        //lbl211b.Text = SPFunctions.LocalizeUI("CCMF_Comp_1_B", "CyberportEMS_CCMFGBAYEP");
                        ...
                        //   lbl212a.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_A", "CyberportEMS_CCMFGBAYEP");
                        //   lbl212b.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_B", "CyberportEMS_CCMFGBAYEP");
                        lbl212c.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_C", "CyberportEMS_CCMFGBAYEP");
                        lbl212d.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_D", "CyberportEMS_CCMFGBAYEP");
                        lbl212e.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_E", "CyberportEMS_CCMFGBAYEP");
                        lbl212f.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_F", "CyberportEMS_CCMFGBAYEP");
                        lbl212g.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_G", "CyberportEMS_CCMFGBAYEP");
                        lbl212h.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_H", "CyberportEMS_CCMFGBAYEP");
                        lbl212i.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_I", "CyberportEMS_CCMFGBAYEP");
                        lbl212j.Text = SPFunctions.LocalizeUI("CCMF_IndComp_2_J", "CyberportEMS_CCMFGBAYEP");
                ...
                case "cbc":
                    {
                        ...
                        //heading2.Text = "-" + SPFunctions.LocalizeUI("Cyberport_Guangdong__Hong_Kong_Young_Entrepreneur_Programme");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("Cross_Border_Programme_Supported_by_CCMF", "CyberportEMS_CCMFGBAYEP");
                        Applicant.Text = SPFunctions.LocalizeUI("Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        lbl211a.Text = SPFunctions.LocalizeUI("CCMF_Comp_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("CCMF_Comp_1_B", "CyberportEMS_CCMFGBAYEP");
                ...
                case "cbuc":
                    {
                        ...
                        //heading1.Text = "-" + SPFunctions.LocalizeUI("Cyberport_University_Partnership_Programme", "CyberportEMS_CCMFGBAYEP");
                        Applicant.Text = SPFunctions.LocalizeUI("Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("CUPP_heading", "CyberportEMS_CCMFGBAYEP");
                        lbl211a.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_B", "CyberportEMS_CCMFGBAYEP");
                        div211b.Disabled = false;
                        ...
                        rdo211b.Enabled = true;
                        //rdo211b.SelectedIndex = -1;
                        //   lbl212a.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_A", "CyberportEMS_CCMFGBAYEP");
                        //    lbl212b.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_B", "CyberportEMS_CCMFGBAYEP");
                        lbl212c.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_C", "CyberportEMS_CCMFGBAYEP");
                        lbl212d.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_D", "CyberportEMS_CCMFGBAYEP");
                        lbl212e.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_E", "CyberportEMS_CCMFGBAYEP");
                        lbl212f.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_F", "CyberportEMS_CCMFGBAYEP");
                        lbl212g.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_G", "CyberportEMS_CCMFGBAYEP");
                        lbl212h.Text = SPFunctions.LocalizeUI("CUPP_IndComp_2_H", "CyberportEMS_CCMFGBAYEP");
                ...
                case "cbui":
                    {
                        ...
                        Applicant.Text = SPFunctions.LocalizeUI("Individual_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        lbl211a.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Ind_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Ind_1_B", "CyberportEMS_CCMFGBAYEP");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("CUPP_heading", "CyberportEMS_CCMFGBAYEP");
                ...
                case "hkyc": //HK YEP Com
                    {
                        ...
                        Applicant.Text = SPFunctions.LocalizeUI("Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("Hong_Kong_Young_Entrepreneur_Programme", "CyberportEMS_CCMFGBAYEP");
                        lbl211a.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_B", "CyberportEMS_CCMFGBAYEP");
                        div211b.Visible = true; // Added by Tim Ng @ 20170316
                        div211b.Disabled = false;

                        lbl211cYepComp.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_C_note", "CyberportEMS_CCMFGBAYEP"); ;
                        ...
                        rdo211b.Enabled = true;
                        Tr11c.Visible = true;
                        lbl211c.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_1_C", "CyberportEMS_CCMFGBAYEP");
                        //rdo211b.SelectedIndex = -1;
                        //        lbl212a.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_A", "CyberportEMS_CCMFGBAYEP");
                        //        lbl212b.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_B", "CyberportEMS_CCMFGBAYEP");                        
                        lbl212c.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_C", "CyberportEMS_CCMFGBAYEP");
                        lbl212d.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_D", "CyberportEMS_CCMFGBAYEP");
                        lbl212e.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_E", "CyberportEMS_CCMFGBAYEP");
                        lbl212f.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_F", "CyberportEMS_CCMFGBAYEP");
                        lbl212g.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_G", "CyberportEMS_CCMFGBAYEP");
                        lbl212h.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_H", "CyberportEMS_CCMFGBAYEP");
                        div212i.Visible = false;
                        div212j.Visible = false;
                        div212a.Visible = false;
                        ...
                        lbl212f_1.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_IndComp_2_F_1", "CyberportEMS_CCMFGBAYEP");
                ...
                case "hkyi": // HK YEP Ind
                    {
                        ...
                        lbl211cYepInd.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Ind_1_C_note", "CyberportEMS_CCMFGBAYEP");
                        if (!string.IsNullOrEmpty(rdo211c.SelectedValue))
                        {
                            if (!Convert.ToBoolean(rdo211c.SelectedValue))
                            {
                ...
                case "hkpc": // HK pro com
                    {
                        Applicant.Text = SPFunctions.LocalizeUI("Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("Professional_Stream", "CyberportEMS_CCMFGBAYEP");
                        div212a.Visible = true;
                        div212b.Visible = true;
                        lbl211a.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_Comp_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_Comp_1_B", "CyberportEMS_CCMFGBAYEP");
                        div211b.Visible = true; // Added by Tim Ng @ 20170316

                        lbl212a.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_A", "CyberportEMS_CCMFGBAYEP");
                        lbl212b.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_B", "CyberportEMS_CCMFGBAYEP");
                        lbl212c.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_C", "CyberportEMS_CCMFGBAYEP");
                        lbl212d.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_D", "CyberportEMS_CCMFGBAYEP");
                        lbl212e.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_E", "CyberportEMS_CCMFGBAYEP");
                        lbl212f.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_F", "CyberportEMS_CCMFGBAYEP");

                        div212f_1.Visible = true;
                        lbl212f_1.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_F_1", "CyberportEMS_CCMFGBAYEP");
                        spn212f_1.InnerHtml = "g)";

                        div212g.Visible = false;
                        //div212g.Visible = false;
                        //lbl212g.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_2_G", "CyberportEMS_CCMFGBAYEP");
                ...
                case "hkpi": //HK pro ind
                    {
                        ...
                        div212a.Visible = true;
                        div212b.Visible = true;
                        lbl211a.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_Ind_1_A", "CyberportEMS_CCMFGBAYEP");
                        lbl211b.Text = SPFunctions.LocalizeUI("HKP_Pro_Stream_Ind_1_B", "CyberportEMS_CCMFGBAYEP");
                        div211b.Visible = true; // Added by Tim Ng @ 20170316
                        div211b.Disabled = false;
                        lbl211btd.Disabled = false;
                        lbl211b.Enabled = true;
                    ...
                    break;
                //TODO: 003a Add ccmfgbayepc in switchStep2UI();
                case "ccmfgbayepc":
                    {
                        Applicant.Text = SPFunctions.LocalizeUI("Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
                        hkorcrossborder.Text = SPFunctions.LocalizeUI("CCMF_GBAYEP_Heading", "CyberportEMS_CCMFGBAYEP");
                        #region 2.1.1
                        ...
                        lbl212f.Text = SPFunctions.LocalizeUI("CCMFGBAYEP_IndComp_2_F", "CyberportEMS_CCMFGBAYEP");
                        lbl212g.Text = SPFunctions.LocalizeUI("CCMFGBAYEP_IndComp_2_G", "CyberportEMS_CCMFGBAYEP");
                        lbl212h.Text = SPFunctions.LocalizeUI("CCMFGBAYEP_IndComp_2_H", "CyberportEMS_CCMFGBAYEP");
                    ...
                    break;
                //TODO: 003b Add ccmfgbayepc in switchStep2UI();
                case "ccmfgbayepi":
                    {
                        Applicant.Text = SPFunctions.LocalizeUI("Individual_Applicant", "CyberportEMS_CCMFGBAYEP");
                        BothApplicants.Text = SPFunctions.LocalizeUI("Individual_and_Company_Applicant", "CyberportEMS_CCMFGBAYEP");
        ...
        //{
        //    return SPUtility.GetSPFunctions.LocalizeUIdString("$Resources:" + Key, "CyberportEMS_CCMFGBAYEP", (uint)SPContext.Current.Web.Locale.LCID);
        ...
        //TODO: 002 Add rdo_CCMFGBAYEP_CheckedChanged
        protected void rdo_CCMFGBAYEP_CheckedChanged(object sender, EventArgs e)
        {
            rdo_HK_Option.Enabled = false;
            rdo_HK_Option.SelectedIndex = -1;
        }
        ...
        //            lblstep12Note.Text =SPFunctions.LocalizeUI("HKP_Pro_Stream_IndComp_Step_1_2_note", "CyberportEMS_CCMFGBAYEP");
        ...
        //            {
        //                lblstep12Note.Visible = true;
        //                lblstep12Note.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Comp_Step_1_2_note", "CyberportEMS_CCMFGBAYEP");
        //            }

        //            else
        //            {
        //                lblstep12Note.Visible = true;
        //                lblstep12Note.Text = SPFunctions.LocalizeUI("HKP_Pro_Young_Ind_Step_1_2_note", "CyberportEMS_CCMFGBAYEP");
        //            }
