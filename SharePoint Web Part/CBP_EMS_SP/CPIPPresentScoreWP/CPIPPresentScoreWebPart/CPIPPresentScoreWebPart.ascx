...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CPIPPresentScoreWebPart.ascx.cs" Inherits="CPIPPresentScoreWP.CPIPPresentScoreWebPark.CPIPPresentScoreWebPark" %>
...
<script type="text/javascript">
    ...
    <div class="rTableRow">
        <div class="rTableCell">Quality and competence of the management team (20%)</div>
    ...
    <div class="rTableRow">
        <div class="rTableCell">Creativity and innovation of the proposed project, product and service (20%)</div>
        <div class="rTableCell">
    ...
    <div class="rTableRow">
        <div class="rTableCell">Market and business viability (30%)</div>
        <div class="rTableCell">
    ...
    <div class="rTableRow">
        <div class="rTableCell">Benefit to Hong Kong’s digital tech industry (10%)</div>
        <div class="rTableCell">
...
<asp:ListItem Value="0.0" Text="0.0" Selected="True"></asp:ListItem>
    ...
    <div class="rTableRow">
        <div class="rTableCell">Proposed six-monthly milestones for the project or business after admission (20%)</div>
        <div class="rTableCell">
