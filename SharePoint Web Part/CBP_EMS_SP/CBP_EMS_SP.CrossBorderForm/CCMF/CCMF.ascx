...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CCMF.ascx.cs" Inherits="CBP_EMS_SP.CrossBorderForm.CCMF.CCMF" %>
    ...
    <div class="main">
        ...
        <div class="custom-form-wd-img border-gray boxcenter width-80 pagewhiteblock">
            <div class="head">
                ...
                <%-- <img src="/_layouts/15/Images/CBP_Images/HK.png" alt="head-logo" class="head-logo" />--%>
            </div>
            ...
            <asp:Panel ID="pnl_InstructionForm" runat="server">
                <h2 class="subheading" style="text-align: left !important; color: #80C343;"><%=SPFunctions.LocalizeUI("Instruction_0", "CyberportEMS_CCMF") %></h2>
                <div>
                    <ol>
                        <li class="eligibility__list">
                            <%=SPFunctions.LocalizeUI("Instruction_1", "CyberportEMS_CCMF") %>
                            <ol>
                                <li>
                                    <%=SPFunctions.LocalizeUI("Instruction_1_1", "CyberportEMS_CCMF") %>
                                </li>
                                <li><%=SPFunctions.LocalizeUI("Instruction_1_2", "CyberportEMS_CCMF") %>
                                </li>
                    ...
                    <div style="padding-top: 10px;">
                        <p class="form-group txt-gray"><%=SPFunctions.LocalizeUI("Instruction_6", "CyberportEMS_CCMF") %></p>
                        <p class="from-group bold txt-gray"><%=SPFunctions.LocalizeUI("Instruction_7", "CyberportEMS_CCMF") %></p>
                        <p class="from-group bold txt-gray"><%=SPFunctions.LocalizeUI("Instruction_8", "CyberportEMS_CCMF") %></p>
                    </div>
            ...
            <div style="position: relative; width: 100%">
                ...
                <%-- <asp:BulletedList ID="progressList" Visible="false" runat="server" class="progressbar progressbar_width" Style="margin: 50px 0; overflow: hidden;">
            ...
            <div class="form">
                <asp:Panel ID="pnl_IncubationStep1" Visible="false" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-wrpr">
                            ...
                            <h2 class="subheading">
                                <%=SPFunctions.LocalizeUI("Step1_Types_Of_CCMF", "CyberportEMS_CCMF") %></h2>

                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>1.1</span>
                                    <%=SPFunctions.LocalizeUI("Step1_CCMF_Selection", "CyberportEMS_CCMF") %></h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    ...
                                    <%=SPFunctions.LocalizeUI("Step_1_CCMF_app", "CyberportEMS_CCMF") %></h2>
                                <div class="sidemargin">
                            ...
                            <div class="form-group" runat="server" id="div1_3Remark" visible="false">
                                <h2 class="subheading text-left"><%=SPFunctions.LocalizeUI("Remarks", "CyberportEMS_CCMF") %></h2>
                                <div class="sidemargin">
                                    <%=SPFunctions.LocalizeUI("Step_1_Remark", "CyberportEMS_CCMF") %>
                                </div>
                            </div>
                ...
                <asp:Panel ID="pnl_IncubationStep2" Visible="false" runat="server">
                    <div class="box-wrpr">
                        <h2 class="subheading"><%=SPFunctions.LocalizeUI("Step2_Heading", "CyberportEMS_CCMF") %></h2>
                        <div class="form-group">
                            <h2 class="subheading text-left">
                                <span>2.1</span>
                ...
                <asp:Panel ID="pnl_IncubationStep3" Visible="false" runat="server">
                    <div class="box-wrpr">
                        <h2 class="subheading"><%=SPFunctions.LocalizeUI("Step3_PROJECT_INFORMATION", "CyberportEMS_CCMF") %></h2>


                        <div class="form-group">
                            <h2 class="subheading text-left">
                                <span>3.1</span>
                                <%=SPFunctions.LocalizeUI("Step3_Project_Name", "CyberportEMS_CCMF") %></h2>
                        ...
                        <div class="form-group">
                            <h2 class="subheading text-left">
                                <span>3.2</span> <%=SPFunctions.LocalizeUI("Step3_1b_CompanyName", "CyberportEMS_CCMF") %>
                                <small><%=SPFunctions.LocalizeUI("Step3_1b_CompanyNameDetail", "CyberportEMS_CCMF") %></small>
                            </h2>
                            <div class="row sidemargin">
                            ...
                            <div class="row sidemargin">
                                <div class="col-md-6">
                                    <h4 class="subheading2">
                                        <span>3.2 a</span> <%=SPFunctions.LocalizeUI("Step3_1c_Establishment", "CyberportEMS_CCMF") %>
                                    </h4>
                            ...
                            <h2 class="subheading text-left">
                                <span>3.3</span>
                                <%=SPFunctions.LocalizeUI("Step3_Abstract", "CyberportEMS_CCMF") %>

                                <small><%=SPFunctions.LocalizeUI("Step3_Abstract_summary", "CyberportEMS_CCMF") %></small></h2>

                            <div class="form-group sidemargin">
                                <h4 class="subheading2">
                                    <span>3.3.1</span>
                                    <%=SPFunctions.LocalizeUI("Step3_English", "CyberportEMS_CCMF") %>
                                </h4>
                            ...
                            <div class="form-group sidemargin">
                                <h4 class="subheading2">
                                    <span>3.3.2</span>
                                    <%=SPFunctions.LocalizeUI("Step3_Chinese", "CyberportEMS_CCMF") %>
                                </h4>
                        ...
                        <div class="form-group">
                            <h2 class="subheading text-left" style="margin-bottom: 8px;">
                                <span>3.4</span>
                                <%=SPFunctions.LocalizeUI("Step3_BusinessArea", "CyberportEMS_CCMF") %></h2>
                            <p class="subheading2 sidemargin"><%=SPFunctions.LocalizeUI("Ste3_BusinessAreasub", "CyberportEMS_CCMF") %></p>
                        ...
                        <div class="form-group">
                            <h2 class="subheading text-left">
                                <span>3.5</span>
                                <%=SPFunctions.LocalizeUI("Step3_AnticipatedDate", "CyberportEMS_CCMF") %></h2>

                            <div class="row">
                                <div class="col-md-6">
                                    <p class="form-group"><%=SPFunctions.LocalizeUI("step3_Commencement", "CyberportEMS_CCMF") %><small class="italic"><%=SPFunctions.LocalizeUI("Step3_day_month_year", "CyberportEMS_CCMF") %></small></p>
                                ...
                                <div class="col-md-6">
                                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step3_Complete_Date", "CyberportEMS_CCMF") %><small class="italic"><%=SPFunctions.LocalizeUI("Step3_day_month_year", "CyberportEMS_CCMF") %></small></p>
                ...
                <asp:Panel ID="pnl_IncubationStep4" Visible="false" runat="server">
                    <div class="form-group">
                        <div class="box-wrpr">
                            <h2 class="subheading"><%=SPFunctions.LocalizeUI("Step_4_Applicatin_Information", "CyberportEMS_CCMF") %></h2>

                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.1(a)</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_project_management", "CyberportEMS_CCMF") %></h2>

                                <div class="form-group sidemargin">
                                    <h4 class="subheading2"><%=SPFunctions.LocalizeUI("Step_4_project_managementsub", "CyberportEMS_CCMF") %>
										</h4>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <div class="form-box form-group" data-id='<%# Container.DataItemIndex+1 %>'>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_3_Name", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                            ...
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_3_Position", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Email", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                            ...
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Nationality", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_3_Hkid", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                                ...
                                                                <br />
                                                                <asp:Label Text="" ID="Label9" runat="server" CssClass="text-gray-client"><small class="italic"><%=SPFunctions.LocalizeUI("ID_Passport_Format", "CyberportEMS_CCMF") %></small></asp:Label>
                                                                <p>
                                                                    <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_hkid_required", "CyberportEMS_CCMF") %>' CssClass="text-danger" Display="Dynamic" ValidationGroup="newCoreMemberValidation" ControlToValidate="HKID" runat="server" />
                                                                </p>
                                                            </div>
                                                            <div class="col-md-6" style="display: none">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_project_management", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                        ...
                                                        <div class="form-group">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_3_Background", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <h2 class="subheading text-left" style="display: inline; margin: 0;">
                                            <small><%=SPFunctions.LocalizeUI("Step_4_project_managementadd", "CyberportEMS_CCMF") %></small>
                                        </h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.1(b)</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_Advisor", "CyberportEMS_CCMF") %>
                                </h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.2</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_Business_model", "CyberportEMS_CCMF") %>
                                </h2>

                                <div class="form-group sidemargin">
                                    <h4 class="subheading2">
                                        <%=SPFunctions.LocalizeUI("Step_4_Business_modelsub", "CyberportEMS_CCMF") %>
										</h4>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.3</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_creativity", "CyberportEMS_CCMF") %>
                                </h2>

                                <div class="form-group sidemargin">
                                    <h4 class="subheading2">
                                        <%=SPFunctions.LocalizeUI("Step_4_creativitysub", "CyberportEMS_CCMF") %>
										</h4>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.4</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_socialresponsibility", "CyberportEMS_CCMF") %>
                                </h2>

                                <div class="form-group sidemargin">
                                    <h4 class="subheading2">
                                        <%=SPFunctions.LocalizeUI("Step_4_socialresponsibilitysub", "CyberportEMS_CCMF") %>
										</h4>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.5</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_competition", "CyberportEMS_CCMF") %> </h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.6</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_Projectmilestone", "CyberportEMS_CCMF") %>

                                    <p class="subheading2"><small><%=SPFunctions.LocalizeUI("Step_4_Projectmilestonesub", "CyberportEMS_CCMF") %> </small></p>
                                </h2>



                                <div class="row">
                                    <div class="col-md-3 greenlbl"><%=SPFunctions.LocalizeUI("Step_4_Milestone", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9 greenlbl"><%=SPFunctions.LocalizeUI("Step_4_Details", "CyberportEMS_CCMF") %> </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_1", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_2", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_3", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_4", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_5", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-3 graylbl"><%=SPFunctions.LocalizeUI("Step_4_Month_6", "CyberportEMS_CCMF") %> </div>
                                    <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left" style="margin-bottom: 8px;">
                                    <span>4.7</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_Cost_Projections", "CyberportEMS_CCMF") %> 
                                </h2>

                                <div class="form-group sidemargin">
                                    <h4 class="subheading2"><small class="italic"><%=SPFunctions.LocalizeUI("Step_4_Cost_Projectionssub", "CyberportEMS_CCMF") %> </small>
                                    </h4>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group sidemargin">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <div class="form-box form-group sidemargin" data-id='<%# Container.DataItemIndex+1 %>'>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step3_Date", "CyberportEMS_CCMF") %> </label>
                                                                </p>
                                                                ...
                                                                <p>
                                                                    <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_date_required", "CyberportEMS_CCMF") %>' CssClass="text-danger" Display="Dynamic" ValidationGroup="newfundingValidation" ControlToValidate="txtApplicationDate" runat="server" />
                                                                </p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Name_of_Programme", "CyberportEMS_CCMF") %> </label>
                                                                </p>
                                                                ...
                                                                <p>
                                                                    <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_name_required", "CyberportEMS_CCMF") %>' CssClass="text-danger" Display="Dynamic" ValidationGroup="newfundingValidation" ControlToValidate="txtNameofProgram" runat="server" />
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Application_Status", "CyberportEMS_CCMF") %> </label>
                                                                </p>
                                                                ...
                                                                <p>
                                                                    <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_appstatus_required", "CyberportEMS_CCMF") %>' CssClass="text-danger" Display="Dynamic" ValidationGroup="newfundingValidation" ControlToValidate="txtApplicationStatus" runat="server" />
                                                                </p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Funding_Status", "CyberportEMS_CCMF") %> </label>
                                                                </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_expenditure", "CyberportEMS_CCMF") %> </label>
                                                                </p>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Currency", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Amount_received", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                                ...
                                                                <br />
                                                                <asp:Label Text="" ID="lblfileformat" runat="server" CssClass="text-gray-client"><small class="italic"><%=SPFunctions.LocalizeUI("Amount_Format", "CyberportEMS_CCMF") %></small></asp:Label>

                                                                <p>
                                                                    <asp:RegularExpressionValidator Display="Dynamic" ErrorMessage='<%#SPFunctions.LocalizeUI("Error_funding_amount1", "CyberportEMS_CCMF") %>' ControlToValidate="txtAmountReceived" CssClass="text-danger" runat="server" ValidationExpression="^(?=.*\d)\d*(?:\.\d\d)?$" />
                                                                </p>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <p>
                                                                    <label><%=SPFunctions.LocalizeUI("Step_4_Maximum_amount", "CyberportEMS_CCMF") %></label>
                                                                </p>
                                                                ...
                                                                <br />
                                                                <asp:Label Text="" ID="Label9" runat="server" CssClass="text-gray-client"><small class="italic"><%=SPFunctions.LocalizeUI("Amount_Format", "CyberportEMS_CCMF") %></small></asp:Label>
                                                                ...
                                                                <p>
                                                                    <asp:RegularExpressionValidator Display="Dynamic" ErrorMessage='<%#SPFunctions.LocalizeUI("Error_max_amt_number", "CyberportEMS_CCMF") %>' ControlToValidate="txtApplicationMaximumAmount" ValidationGroup="newfundingValidation" CssClass="text-danger" runat="server" ValidationExpression="^(?=.*\d)\d*(?:\.\d\d)?$" />
                                                                </p>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="form-group sidemargin">
                                        ...
                                        <h2 class="subheading text-left" style="display: inline; margin: 0;">
                                            <small><%=SPFunctions.LocalizeUI("Step_4_fundingadd", "CyberportEMS_CCMF") %></small>
                                        </h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.9</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_Exit_strategy", "CyberportEMS_CCMF") %>
                                </h2>
                            ...
                            <div class="form-group">
                                <h2 class="subheading text-left">
                                    <span>4.10</span>
                                    <%=SPFunctions.LocalizeUI("Step_4_additional_information", "CyberportEMS_CCMF") %>
                                </h2>
                ...
                <asp:Panel ID="pnl_IncubationStep5" Visible="false" runat="server">
                    <div class="box-wrpr">
                        <h2 class="subheading">
                            <span>5.</span>
                            <%=SPFunctions.LocalizeUI("Step_5_CONTACT_DETAILS", "CyberportEMS_CCMF") %></h2>
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <%--<h2 class="subheading text-left"><%=SPFunctions.LocalizeUI("Step_5_Contact_Person", "CyberportEMS_CCMF") %> <%# Container.DataItemIndex+1 %> <%=SPFunctions.LocalizeUI("Step_5_Principal_Applicant", "CyberportEMS_CCMF") %></h2> --%>
                                            <h2 class="subheading text-left">
                                            ...
                                            <div class="form-group sidemargin">
                                                <div class="form-box form-group" data-id="<%# Container.DataItemIndex+1 %>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Salution", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                        ...
                                                        <div class="col-md-4">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Last_Name", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                            ...
                                                            <p>
                                                                <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_contact_lastname_req", "CyberportEMS_CCMF") %>' Display="Dynamic" ValidationGroup="newCOntactDetailValidation" CssClass="text-danger" ControlToValidate="txtContactLast_name" runat="server" />
                                                            </p>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_First_Name", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                            ...
                                                            <p>
                                                                <asp:RequiredFieldValidator ErrorMessage='<%#SPFunctions.LocalizeUI("Error_contact_firstname_req", "CyberportEMS_CCMF") %>' Display="Dynamic" ValidationGroup="newCOntactDetailValidation" CssClass="text-danger" ControlToValidate="txtContactFirst_name" runat="server" />
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Last_Name_Chi", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                        ...
                                                        <div class="col-md-4">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_First_Name_Chi", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Contact_No", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                            ...
                                                            <br />
                                                            <asp:RegularExpressionValidator Display="Dynamic" ErrorMessage='<%#SPFunctions.LocalizeUI("Error_Contact_no", "CyberportEMS_CCMF") %>' ControlToValidate="txtContactNo" CssClass="text-danger" runat="server" ValidationExpression="^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Fax", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                            ...
                                                            <br />
                                                            <asp:RegularExpressionValidator Display="Dynamic" ErrorMessage='<%#SPFunctions.LocalizeUI("Error_fax", "CyberportEMS_CCMF") %>' ControlToValidate="txtContactFax" CssClass="text-danger" runat="server" ValidationExpression="^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$" />
                                                        </div>
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Email", "CyberportEMS_CCMF") %></label>
                                                            </p>
                                                            ...
                                                            <br />
                                                            <asp:RegularExpressionValidator Display="Dynamic" ErrorMessage='<%#SPFunctions.LocalizeUI("Error_email", "CyberportEMS_CCMF") %>' CssClass="text-danger" ControlToValidate="txtContactEmail" runat="server" ValidationExpression="^[\w\.=-]+@[\w\.-]+\.[\w]{2,3}$" />
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        <p>
                                                            <label><%=SPFunctions.LocalizeUI("Step_5_Mailing_Address", "CyberportEMS_CCMF") %></label>
                                                        </p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label>
                                                                    <%=SPFunctions.LocalizeUI("Step_5_Institutiuon", "CyberportEMS_CCMF") %>
                                                                    <br />
                                                                    <small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small></label>
                                                            </p>
                                                        ...
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label>
                                                                    <%=SPFunctions.LocalizeUI("Step_5_Student_idcard", "CyberportEMS_CCMF") %>

                                                                    <br />
                                                                    <small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label>
                                                                    <%=SPFunctions.LocalizeUI("Step_5_Programme_Enrolled_Eng", "CyberportEMS_CCMF") %><br />
                                                                    <small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small></label>
                                                            </p>
                                                        ...
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label>
                                                                    <%=SPFunctions.LocalizeUI("Step_5_dateofgrad", "CyberportEMS_CCMF") %>
                                                                    <br />
                                                                    <small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small></label>
                                                            </p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Org_name", "CyberportEMS_CCMF") %><small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small></label>
                                                            </p>
                                                        ...
                                                        <div class="col-md-5">
                                                            <p>
                                                                <label><%=SPFunctions.LocalizeUI("Step_5_Position", "CyberportEMS_CCMF") %><small><%=SPFunctions.LocalizeUI("Step_5_applicable", "CyberportEMS_CCMF") %></small></label>
                                                            </p>
                ...
                <asp:Panel ID="pnl_IncubationStep6" Visible="false" runat="server">
                    <div class="box-wrpr" style="width: 700px; margin: 0 auto;">
                        ...
                        <div class="row" runat="server" id="attachbrcopy" visible="false">
                            ...
                            <div class="col-md-6">
                                <div class="dirbox">
                                    ...
                                    <asp:Label Text="" ID="lblfileformat" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_type", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                    <asp:Label Text=" " ID="lblfilesize" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_size", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                        ...
                        <div class="row" runat="server" id="attachstudentid" visible="false">
                            <label class="col-md-6 lbl" runat="server" id="studnt_id">
                                <asp:PlaceHolder runat="server"><%=SPFunctions.LocalizeUI("StudentID", "CyberportEMS_CCMF") %></asp:PlaceHolder>
                            </label>
                            <div class="col-md-6">
                                <div class="dirbox">
                                    <asp:FileUpload AllowMultiple="false" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.png,.jpg,.gif"
                                    ...
                                    <br />
                                    <asp:Label Text="" ID="Label1" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_type", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                    <asp:Label Text=" " ID="Label2" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_size", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                ...
                                <div class="dirbox">
                                    ...
                                    <asp:Repeater runat="server" ID="rptrHKID" OnItemCommand="Attachments_ItemCommand" OnItemDataBound="rptrOtherAttachement_ItemDataBound">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td>
                                                    <%--<a href='<%#SPContext.GetContext(System.Web.HttpContext.Current).Site.Url +"/"+Eval("Attachment_Path") %>' target="_blank">
                                                        <%#((Convert.ToString(Eval("Attachment_Path")) != "") ? Convert.ToString(Eval("Attachment_Path")).Remove(0,  Convert.ToString(Eval("Attachment_Path")).LastIndexOf("/") + 1) : "") %></a>--%>
                                                    <a>
                                                        <%#((Convert.ToString(Eval("Attachment_Path")) != "") ? Convert.ToString(Eval("Attachment_Path")).Remove(0,  Convert.ToString(Eval("Attachment_Path")).LastIndexOf("/") + 1) : "") %></a>
                                                </td>
                                    ...
                                    <br />
                                    <asp:Label Text="" ID="Label3" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_type", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                    <asp:Label Text=" " ID="Label4" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_size", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                        ...
                        <div class="row">
                            <label class="col-md-6 lbl" runat="server" id="presentation_slide">
                                <asp:PlaceHolder runat="server"><%=SPFunctions.LocalizeUI("PresentationSlide", "CyberportEMS_CCMF") %></asp:PlaceHolder>
                            </label>
                            <div class="col-md-6">
                                <div class="dirbox">
                                    ...
                                    <br />
                                    <asp:Label Text="" ID="Label5" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_type_presntation", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                    <asp:Label Text=" " ID="Label6" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_size", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                        ...
                        <div class="row">
                            <label class="col-md-6 lbl" runat="server" id="other">
                                <asp:PlaceHolder runat="server"><%=SPFunctions.LocalizeUI("OtherAttachment", "CyberportEMS_CCMF") %></asp:PlaceHolder>
                            </label>
                            <div class="col-md-6">
                                <div class="dirbox">
                                    <asp:FileUpload AllowMultiple="false" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.png,.jpg,.gif"
                                    ...
                                    <br />
                                    <asp:Label Text="" ID="Label7" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_type", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                                    <asp:Label Text=" " ID="Label8" runat="server" CssClass="text-gray-client"><%=SPFunctions.LocalizeUI("File_size", "CyberportEMS_CCMF") %></asp:Label>
                                    <br />
                    ...
                    <p class="form-group bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_Purpose", "CyberportEMS_CCMF") %> </p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Purpose_1", "CyberportEMS_CCMF") %> </p>

                    <ul class="form-group bult">
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_2", "CyberportEMS_CCMF") %> </li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_3", "CyberportEMS_CCMF") %> </li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_4", "CyberportEMS_CCMF") %>  </li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_5", "CyberportEMS_CCMF") %> </li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_6", "CyberportEMS_CCMF") %> </li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Purpose_7", "CyberportEMS_CCMF") %> </li>
                    </ul>

                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Purpose_8", "CyberportEMS_CCMF") %></p>

                    <p class="form-group bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_Transfer_data", "CyberportEMS_CCMF") %></p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Transfer_data_1", "CyberportEMS_CCMF") %> </p>

                    <ul class="form-group  bult">
                        <li><%=SPFunctions.LocalizeUI("Step_6_Transfer_data_2", "CyberportEMS_CCMF") %></li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Transfer_data_3", "CyberportEMS_CCMF") %></li>
                        <li><%=SPFunctions.LocalizeUI("Step_6_Transfer_data_4", "CyberportEMS_CCMF") %> </li>
                    </ul>

                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Transfer_data_note", "CyberportEMS_CCMF") %></p>


                    <p class="form-group bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_Direct_marketing", "CyberportEMS_CCMF") %></p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Direct_marketing_1", "CyberportEMS_CCMF") %></p>

                    <p class="form-group"><span class="bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_cyberport", "CyberportEMS_CCMF") %></span> <%=SPFunctions.LocalizeUI("Step_6_cyberport_1", "CyberportEMS_CCMF") %> </p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_cyberport_2", "CyberportEMS_CCMF") %> </p>

                    <p class="form-group bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_Privacy", "CyberportEMS_CCMF") %></p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Privacy_2", "CyberportEMS_CCMF") %> </p>
                    <p class="form-group bold graylbl"><%=SPFunctions.LocalizeUI("Step_6_Access", "CyberportEMS_CCMF") %></p>
                    <p class="form-group"><%=SPFunctions.LocalizeUI("Step_6_Access_1", "CyberportEMS_CCMF") %></p>

                    <p class="form-group"><%=SPFunctions.LocalizeUI("STEP_6_STATEMENT", "CyberportEMS_CCMF") %> </p>


                    <div class="green-clr-theme">
                        <asp:CheckBox runat="server" ID="Personal_Information" CssClass="listcss" Text="&nbsp;" />
                        <%=SPFunctions.LocalizeUI("step_6_personal_information_collection", "CyberportEMS_CCMF") %>
                        <br />
                        <asp:CheckBox runat="server" ID="Marketing_Information" CssClass="listcss" Text="&nbsp;" />
                        <%=SPFunctions.LocalizeUI("step_6_marketing", "CyberportEMS_CCMF") %>
                    </div>
...
<script>
    ...
    //    }
    //});
    //$(".datepickerMonthY").attr('readonly', 'readonly');
    //$(".datepickerDMonthY").attr('readonly', 'readonly');
